    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Login ou mot de passe invalide"/*"Invalid username or password."*/);
                }
            }
        ...
        {
            ViewBag.profil = new SelectList(RoleManager.Roles.ToList(), "Id", "Name");
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string Privilege)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var role = await RoleManager.FindByIdAsync(Privilege);
                    UserManager.AddToRole(user.Id, role.Name);
                    await SignInAsync(user, isPersistent: false);
                    return RedirectToAction("Index","TableaudeBord"/*"Index", "Home"*/);
                }
                else
                {
                    AddErrors(result);
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                //return RedirectToAction("Index", "Home"); CLDev
